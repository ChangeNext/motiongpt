...
def main():
    ...
    avg_recons, avg_perplexity, avg_commit = 0., 0., 0.
    best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer, logger = vqvae_evaluation(args.out_dir, val_loader, net, logger, writer, eval_wrapper,0, best_fid=1000, best_div=100, best_top1=0, best_top2=0, best_top3=0, best_matching=100, is_train=True)
    ...
    for nb_iter in range(1, args.total_iter + 1):
        ...
        if nb_iter % args.eval_iter==0 :
            best_fid, best_div, best_top1, best_top2, best_top3, best_matching, writer, logger = vqvae_evaluation(args.out_dir, val_loader, net, logger, writer, eval_wrapper, nb_iter, best_fid, best_div, best_top1, best_top2, best_top3, best_matching, is_train=True)
